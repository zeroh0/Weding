...
<div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-md-between py-3 mb-4 border-bottom">
      <a href="main" class="main">We-DING</a>

      <ul class="nav">
        <li><a href="beforeFundList" class="nav-link px-2 link-dark">펀딩예정</a></li>
        <li><a href="fundingList" class="nav-link px-2 link-dark">펀딩하기</a></li>
        <li><a href="boardList?main_cat=300&mini_cat=100" class="nav-link px-2 link-dark">공지사항</a></li>
        <li><a href="boardList?main_cat=300&mini_cat=200" class="nav-link px-2 link-dark">문의사항</a></li>
      </ul>
